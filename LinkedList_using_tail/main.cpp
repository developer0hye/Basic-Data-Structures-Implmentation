...
int main()
{
    ...
    cout << "Test to add node at end(=tail) (data)" << endl << endl;

    cout << "Add node at end (1)" << endl << endl;
    cout << "Add node at end (3)" << endl << endl;
    cout << "Add node at end (4)" << endl << endl;
    cout << "Add node at end (6)" << endl << endl;
    ...
    cout << "Add node at beginning (0, 15)" << endl << endl;
    cout << "Add node at beginning (0, 17)" << endl << endl;

    linkedList.Push(0, 15);
    linkedList.Push(0, 17);
